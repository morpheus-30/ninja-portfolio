...
const DRAFT_PATH = path.join("/tmp", "portfolio-draft.json");

/**
 * Default portfolio data structure.
 * This mirrors src/data/portfolio.js — serves as the initial draft state.
 */
const DEFAULT_DATA = {
  profile: {
  ...
  bio: {
    ...
    intro:
      "Associate Software Engineer building practical systems across enterprise software, automation, AI-powered tools, and developer productivity solutions.",
    paragraphs: [
    ...
    blurb:
      "Nakshatra Chandna enjoys building systems that solve real problems through enterprise applications, automation platforms, developer tools, and AI-powered products. His focus is on creating software that is reliable, maintainable, and useful in real-world environments while continuously exploring new technologies and engineering practices.",
  },
  skills: [
    {
  ...
  projects: [
    {
      title: "UNLOOP",
      description:
        "A productivity-focused platform designed to reduce short-form content consumption across applications such as YouTube Shorts and Instagram Reels. Handles real-time activity tracking, browser event detection, navigation monitoring, and behavioral analytics.",
    ...
    },
    {
      title: "CLISKY",
      description:
        "An AI-powered command-line assistant that detects the user's environment and generates contextual commands. Built with a modular architecture supporting Linux distribution awareness, environment configuration, and AI-assisted command generation.",
    ...
    },
    {
      title: "Gitroaster",
      description:
        "A deployed web application that analyzes GitHub profiles using repository metadata and activity patterns to generate context-aware AI-powered insights and humorous evaluations.",
...
function hasDraft() {
  return fs.existsSync(DRAFT_PATH);
}

module.exports = { readDraft, writeDraft, hasDraft, DEFAULT_DATA };
